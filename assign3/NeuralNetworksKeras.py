...
print("The softmax action function was use for the output layer because it is a generalization of the logistic function "
      "that is used for multi-class classification problems. "
      "It squashes a K-dimensional vector of arbitrary real values to a K-dimensional vector of real values in the range (0, 1) that add up to 1.") #5 points
...
print("The size of the first hidden layer is (None, 300). None means the batch size is unspecified.\
The total number of parameters of the first hidden layer is 235,500, which refers to the number of 784 * 300 weights and 300 biases") #8 points
model.summary()
...
print("An epoch is a hyperparameter that defines the number of times that "
"the learning algorithm will work through the entire training dataset."); #6 points
